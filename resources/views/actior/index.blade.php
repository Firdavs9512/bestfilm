        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Actior /</span> Index</h4>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card">
                        <h5 class="card-header">Actiors list</h5>
                        <div class="table-responsive text-nowrap">
                                  ...
                                  <td>
                                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="" data-bs-original-title="{{ $actior->name }}">
                                          <img src="{{ url('storage/'.$actior->photo) }}" alt="image" class="rounded-circle">
                                        </li>
                                      </ul>
                                    </td>
                                    <td><span class="badge bg-label-primary me-1">{{ $actior->country }}</span></td>
                                    <td>
                                        <div class="dropdown">
                          ...
                          <div class="row mx-2 mt-2">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Showing {{ $actiors->firstItem() }} to {{ $actiors->lastItem() }} of {{ $actiors->total() }}
                                    entries</div>
                            </div>
                            <div class="col-sm-12 col-md-6">
