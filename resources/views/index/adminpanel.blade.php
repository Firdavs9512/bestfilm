                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Congratulations Firdavs! 🎉</h5>
                          <p class="mb-4">
                            You have done <span class="fw-bold">72%</span> more sales today. Check your new badge in
                            your profile.
                          </p>

                          <a href="{{ route('movieindex') }}" class="btn btn-sm btn-outline-primary">List movies</a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> All</small>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span>Images</span>
                          <h3 class="card-title text-nowrap mb-1">{{ $imagetotal }}</h3>
                          <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> Upload</small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        ...
                        <small class="text-muted">Total statistik</small>
                      </div>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                        ...
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded bg-label-primary"
                              > <i class='bx bxs-category'></i> </span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <h6 class="mb-0">Categories</h6>
                              <small class="text-muted">All category</small>
                            </div>
                            <div class="user-progress">
                              <small class="fw-semibold">{{ $categorycount }}</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-4 pb-1">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded bg-label-success"><i class='bx bxs-purchase-tag'></i></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <h6 class="mb-0">Tags</h6>
                              <small class="text-muted">All tag</small>
                            </div>
                            <div class="user-progress">
                              <small class="fw-semibold">{{ $tagcount }}</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex mb-4 pb-1">
                          ...
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <h6 class="mb-0">Actiors</h6>
                              <small class="text-muted">All actior</small>
                            </div>
                            <div class="user-progress">
                              <small class="fw-semibold">{{ $actiorcount }}</small>
                            </div>
                          </div>
                        </li>
                        <li class="d-flex">
                          <div class="avatar flex-shrink-0 me-3">
                            <span class="avatar-initial rounded bg-label-secondary"
                              ><i class='bx bx-movie'></i></span>
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                              <h6 class="mb-0">Movies</h6>
                              <small class="text-muted">All movies</small>
                            </div>
                            <div class="user-progress">
                              <small class="fw-semibold">{{ $moviecount }}</small>
                            </div>
                          </div>
                        </li>
                      </ul>
            ...
            <footer class="content-footer footer bg-footer-theme">
                <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                  <div class="mb-2 mb-md-0">
                    ...
                    , made with ❤️ by
                    <a href="#" target="_blank" class="footer-link fw-bolder">Firdavs</a>
                  </div>
...
(function () {
  ...
  const chartOrderStatistics = document.querySelector('#orderStatisticsChart'),
    orderChartConfig = {
      ...
      labels: ['Category', 'Actior', 'Tag', 'Movie'],
      series: [{{ $categorycount }}, {{ $actiorcount }}, {{ $tagcount }}, {{ $moviecount }}],
