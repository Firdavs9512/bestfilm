        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Movies /</span> Index</h4>
                ...
                <div class="col-xxl">
                    <div class="card">
                      ...
                      <div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
                        ...
                        <h5 class="card-header">Index setting</h5>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="collapseExample" style="">
                              <div class="d-grid d-sm-flex p-3 border">
                                <img src="../assets/img/elements/1.jpg" alt="collapse-image" class="me-4 mb-sm-0 mb-2" height="125">
                                <span>
