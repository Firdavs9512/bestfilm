          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('tagindex') }}" class="menu-link">
                    <div data-i18n="Basic Inputs">Tag list</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item ">
                    <a href="{{ route('usercreate') }}" class="menu-link">
            ...
            <li class="menu-item">
              ...
              >
                ...
                <div data-i18n="Support">Movie list</div>
              </a>
            </li>
            <li class="menu-item">
              <a
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tags /</span> Create</h4>
                    ...
                    <div class="card-body">
                      <form action="{{ route('tagupdate',$tag->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="name" value="{{ $tag->name }}" class="form-control" id="basic-default-name" placeholder="Tag name" />
                            @error('name')
