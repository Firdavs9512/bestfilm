                    ...
                    <div class="modal-dialog modal-sm " role="document">
                      <div class="modal-content alert-primary">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col mb-0">
                                <h5 class="mb-0">Deleted this User!</h5>
                            </div>
                          </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <button onclick="deleteid({{ $user->id }})" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#smallModal"><i class="bx bx-trash me-1"></i> Delete</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
